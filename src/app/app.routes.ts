...
export const routes: Routes = [
  ...
  { path: 'miscellany', loadChildren: () => import('./../features/miscellany/miscellany.module').then(m => m.MiscellanyModule ) },
  { path: 'machine-learning', loadChildren: () => import('./../features/ml/ml.module').then(m => m.MLModule) },
