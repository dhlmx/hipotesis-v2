...
export const routes: Routes = [
  ...
  { path: 'misc', loadChildren: () => import('./../features/misc/miscellany.module').then(m => m.MiscellanyModule ) },
  { path: 'ml', loadChildren: () => import('./../features/ml/ml.module').then(m => m.MLModule) },
  { path: 'pp', loadChildren: () => import('./../features/preprocessing/preprocessing.module').then(m => m.PreprocessingModule) },
